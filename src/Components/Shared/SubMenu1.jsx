...
const SubMenu1 = () => {
  ...
  const [currentItems, setCurrentItems] = useState(subMenuItems[0].childItems);

  return (
    <div className="grid grid-cols-3 rounded-lg w-[814px] h-[419px] ">
      <div className="col-start-1 col-span-1 bg-bg-secondary relative mr-1 h-full">
        <ul className="absolute left-0 h-full bg-transparent z-30 w-full">
          {subMenuItems.length > 0 &&
            subMenuItems.map(({ name, desc, childItems }, id) => (
              <li
                key={id}
                className={` p-4 `}
                onMouseEnter={(e) => {
        ...
        <div
          ...
          className={`absolute w-[98.50%]  left-0 bg-white transition-all duration-300 z-20`}
        ></div>
        <span
      ...
      <div className="col-start-2 col-span-2 px-6 pt-8 pb-3">
        <div>
          <ul
            ...
            >
              ...
              <div className="flex gap-1 items-center">
                ...
                <p className="flex items-center">
                  ...
                  <RiArrowDropRightLine className="text-lg group-hover:text-[0]transition-all duration-300 group-hover:opacity-0" />
                </p>
              </div>
            </a>
          )}
