    ...
    items: [
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--supportCenter SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--blog SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="17"
            viewBox="0 0 16 17"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--supportPlan SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--sessions SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--document SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              ...
              fill="var(--basicIconColor)"
            ></path>
            <path d="M14 5L9 0V5H14Z" fill="var(--basicIconColor)"></path>
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--letter SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--customers SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
    ...
    items: [
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--jobs SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--article SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      },
      {
        ...
        icon: (
          <svg
            className="BasicIcon BasicIcon--certificate SiteNavItem__basicIcon  fill-icon-color group-hover:fill-title-color"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
